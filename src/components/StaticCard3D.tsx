    ...
    <div className="flex flex-col items-center">
      ...
      >
        ...
        >
          ...
          >
            {hpString ? hpString.replace(/\B(?=(\d{3})+(?!\d))/g, ",") : "0"} HP
          </div>
          ...
          >
            {cardData.followers.toLocaleString()} Followers{" "}
            {cardData.following.toLocaleString()} Following
          </div>
